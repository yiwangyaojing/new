<template>
  <el-card class="box-card">
    ...
    <el-row style="margin:15px">
      <el-col :span="24">
        <el-table :data="pageInfo.content" style="width: 100%; margin-top: 25px; " border>
        ...
        <img  v-for="(item,index) in scope.row.images" :key="index" :src="item.mini_url"  width="60" height="60" @click="showMax(item.url)"  style="margin-left: 5px"/>
        </template>
        </el-table-column>
